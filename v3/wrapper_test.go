...
func TestFit(t *testing.T) {
	...
	_, err := libSvm.Fit([][]float64{}, []float64{1, 2}, nil)
	if err == nil || err.Error() != "unbalanced input data" {
		t.Fatalf("Test failed. Expecting: 'unbalanced input data'; Actual: '%v'", err.Error())
	}
